  ...
  <header class="hero">
    <nav class="navbar">
      ...
      <div class="nav-links" id="primaryNavigation">
        ...
        <a href="#ai-planner">AI Planlayıcı <span class="soon-inline">Yakında</span></a>
  ...
  <main id="main">
    <section class="section intro" id="how">
      <div class="section-heading">
        ...
        <h2>KampanyaLab AI destekli kampanya planlayıcıya hazırlanıyor</h2>
      </div>
      <div class="features">
        <article>
        ...
        <article>
          ...
          <p>Serbest metinle plan üretme özelliği yakında aktif olacak. Şimdilik medya planı motoru ve hazır şablonları kullanabilirsin.</p>
        </article>
      </div>
    </section>
    ...
    <section class="section ai-section" id="ai-planner">
      <div class="section-heading">
        <p class="badge">AI destekli planlayıcı · Yakında</p>
        <h2>AI kampanya planlayıcı yakında aktif olacak.</h2>
        <p>Bu bölüm şimdilik tanıtım modunda. OpenAI API ücretli kullanım gerektirdiği için AI taslak oluşturma özelliği geçici olarak kapalıdır.</p>
      </div>
      ...
      <div class="ai-grid">
        <form id="aiPlannerForm" class="panel ai-form" autocomplete="off">
          <label>
            Kampanya briefi
            <textarea id="aiPrompt" maxlength="1200" rows="7" placeholder="Yakında: Kampanya ihtiyacını buraya yazıp AI destekli strateji taslağı alabileceksin." disabled></textarea>
            <span class="field-help">Kişisel bilgi, şifre, ödeme bilgisi veya özel veri yazma. Maksimum 1200 karakter.</span>
          </label>
          <div class="ai-actions">
            <button id="generateAiPlan" class="btn primary" type="submit" disabled>Yakında Aktif Olacak</button>
          ...
          <p class="notice">AI planlayıcı şimdilik kapalıdır. Medya planı motoru, hazır şablonlar ve PDF rapor sistemi çalışmaya devam eder.</p>
        </form>
        ...
        <div class="panel ai-result-panel">
          ...
          <div id="aiResult" class="ai-result empty">
            <p>AI destekli kampanya planlayıcı yakında aktif edilecektir. Şimdilik aşağıdaki hazır şablonları ve medya planı motorunu kullanabilirsin.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section trust" id="trust">
      <div class="section-heading">
        ...
        <p>Form hesaplamaları tarayıcı içinde yapılır. AI planlayıcı şimdilik yakında modundadır ve veri gönderimi yapmaz.</p>
      </div>

      <div class="trust-grid">
        <article class="panel trust-card">
          <h3>Tarayıcıda hesaplama</h3>
          <p>Formdaki bütçe, sektör, hedef ve süre bilgileri tarayıcıda hesaplanır. AI planlayıcı şimdilik kapalıdır; aktif edildiğinde kullanıcıya ayrıca bilgi verilecektir.</p>
        </article>
        <article class="panel trust-card">
  ...
  <footer class="footer">
    <div class="footer-inner">
      ...
      <p class="footer-note">
        ...
        Form hesaplamaları tarayıcıda yapılır. AI planlayıcı şimdilik yakında modundadır; veri gönderimi yapmaz.
      </p>
    </div>
  </footer>
